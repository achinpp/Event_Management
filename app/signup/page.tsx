        ...
        <div className="rounded-2xl border border-zinc-200/80 bg-white/70 p-8 shadow-xl backdrop-blur-md transition-colors duration-300 dark:border-zinc-800/80 dark:bg-zinc-900/40">
          {success ? (
            <div className="space-y-4 text-center">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-green-500/10 text-green-600 border border-green-500/20 dark:bg-green-500/10 dark:text-green-400 dark:border-green-400/20">
                <svg className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                </svg>
              </div>
              <h2 className="text-lg font-bold text-zinc-800 dark:text-zinc-200">Registration Successful!</h2>
              <p className="text-xs text-zinc-500 dark:text-zinc-400">Redirecting you to the login page...</p>
            </div>
          ) : (
