    ...
    <div className="relative w-full">
      ...
      <div className="group relative">
        <button
          ...
          className={`flex w-full items-center justify-between gap-2.5 rounded-xl border px-3.5 py-2.5 text-sm transition-all duration-200 focus:outline-none ${
            isOpen
        ...
        >
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            {selectedDate ? (
              ...
              <span className="text-zinc-400 dark:text-zinc-500 text-sm">
                Choose event starting date & time...
              </span>
            )}
          </div>
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            {selectedDate && (
              <>
                <span className={`hidden sm:inline-flex items-center rounded-md border px-1.5 py-0.5 text-[10px] font-semibold ${getRelativeBadge(selectedDate).color}`}>
                  {getRelativeBadge(selectedDate).text}
                </span>
                <span
                  role="button"
                  tabIndex={0}
                  ...
                  className="rounded-md p-1 text-zinc-400 hover:bg-zinc-200 hover:text-zinc-700 dark:hover:bg-zinc-800 dark:hover:text-zinc-200 transition-colors"
                  title="Clear date"
                >
            ...
            <svg
              className={`h-4 w-4 text-zinc-400 transition-transform duration-200 ${isOpen ? "rotate-180 text-indigo-600 dark:text-indigo-400" : ""}`}
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
              viewBox="0 0 24 24"
